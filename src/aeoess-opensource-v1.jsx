...
function AeoessOpenSourceV1({ palette, density, showProof, heroFont }) {
  const P = palette;
      ...
      <section style={{ padding: `${sectionPadY}px ${pad}px ${sectionPadY - 30}px` }}>
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: 48, alignItems: 'baseline', marginTop: 32 }}>
            {[
              ...
              <div key={s.l}>
                ...
                <div style={{ fontSize: 11, color: P.ink5, marginTop: 8, letterSpacing: '0.10em', fontFamily: mono }}>{s.l}</div>
              </div>
              )}
          </div>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, alignItems: 'center', marginTop: 28 }}>
            ...
            <span style={{ fontSize: 12, color: P.ink5, marginLeft: 4 }}>
              draft-pidlisnyi-aps-00 (IETF)
            </span>
          </div>

          {/* Two install commands side by side, directly under action buttons */}
          <div style={{
            ...
            {[
              ...
              <div key={i} style={{
                ...
                padding: '12px 16px', fontFamily: mono, fontSize: 13.5, color: P.ink
              }}>
          ...
          {/* Independently cited, left-rule callout */}
          {showProof &&
            <div style={{
              marginTop: 24, padding: '14px 18px',
              borderLeft: `3px solid ${P.accentColor}`,
              background: P.surface, border: `1px solid ${P.ruleLight}`, borderLeftWidth: 3,
              borderRadius: '0 6px 6px 0',
              fontSize: 13.5, lineHeight: 1.55, color: P.ink2
            }}>
              <span style={{ fontWeight: 700 }}>Independently cited</span>
              <span style={{ color: P.ink5 }}>, </span>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 18, marginTop: 14 }}>
            {[
              ...
              <a key={label} href="#" style={{
                fontSize: 13, color: P.link, textDecoration: 'none', fontWeight: 500
              }}>{label}</a>
              )}
          </div>
          ...
          <div style={{ marginTop: 28 }}>
            <div style={{
                fontSize: 11, color: P.ink5, fontFamily: mono,
                letterSpacing: '0.10em', textTransform: 'uppercase', marginBottom: 10
              }}>
              Quick start <span style={{ color: P.ink5 }}>–</span> <span style={{ textTransform: 'none', letterSpacing: 0, fontFamily: 'inherit', color: P.ink4 }}>Core subpath, curated essentials</span>
            </div>
            <pre style={{
...
// full API surface still available at `}<span style={{ color: '#7ecf8c' }}>{`'agent-passport-system'`}</span></code>
      ...
      {/* ── Architecture (live visualization, six tabs in one) ──────── */}
      <section style={{ padding: `${sectionPadY - 30}px ${pad}px ${sectionPadY}px`, borderTop: `1px solid ${P.ruleLight}` }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ border: `1px solid ${P.ruleLight}`, borderRadius: 6, overflow: 'hidden', background: '#1c1c1e' }}>
            <iframe
              src="protocol-architecture.html"
              title="AEOESS protocol architecture, six scenes"
              loading="lazy"
...
Object.assign(window, { AeoessOpenSourceV1 });