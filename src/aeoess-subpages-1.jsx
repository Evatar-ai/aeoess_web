...
function AeoessBlog({ palette }) {
  ...
  const POSTS = [
    { date:'Jul 21', kind:'standard', title:'Vocabulary co-stewardship proposed to DIF', tease:'Opened an issue at the DIF Trusted AI Agents working group proposing that the agent governance vocabulary move to shared stewardship. Editorial and implementation work stays with us. Naming and admission gain independent oversight, out in the open next to the other groups on the same ground.', read:'3 min' },
    { date:'Jul 21', kind:'standard', title:'Delegation chains: well-formed is not verified', tease:'Commented on the A2A actor-chain delegation proposal. A chain that narrows cleanly at every hop is internally consistent, not proof of authority, since the payload is written by the caller. Monotonic narrowing checks the reported chain. It is not a credential.', read:'2 min' },
